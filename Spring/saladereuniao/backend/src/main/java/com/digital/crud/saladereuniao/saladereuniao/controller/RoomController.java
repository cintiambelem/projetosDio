...
import com.digital.crud.saladereuniao.saladereuniao.exception.ResourcesNotFoundException;
...
@RestController @CrossOrigin(origins = "http://localhost:4200") //porta padrão angular.
